...
public class VinConvert {
    ...
    public CheModel search(String vin) {
        return this.search4Free(vin);
    }

    private CheModel search4Free(String vin) {
            ...
            if(jsonObject.containsKey("code") && jsonObject.containsKey("data")
                ...
                if(data != null) {
                    ...
                    if(!StringUtils.isEmpty(brandName) && !StringUtils.isEmpty(seriesName)
                        ...
                        cheModel = new CheModel(brandName, seriesName, modelName);
                    }
                }
            }
        }
